...
<div class="navber">
    ...
    <nav class="MenuBar clearfix pinned-colelem" id="menuu17227">
        ...
        <div class="MenuItemContainer clearfix grpelem" id="u17228">
            <!-- vertical box -->
            <a class="nonblock nontext MenuItem MenuItemWithSubMenu {{ Request::is('/') ? 'MuseMenuActive' : '' }} clearfix colelem"
        ...
        <div class="MenuItemContainer clearfix grpelem" id="u17270">
            <!-- vertical box -->
            <a class="nonblock nontext MenuItem MenuItemWithSubMenu {{ Request::is('about') ? 'MuseMenuActive' : '' }} clearfix colelem"
